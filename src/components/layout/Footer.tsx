          ...
          <div className="py-14 flex flex-col lg:flex-row justify-between gap-10 lg:gap-16">
            ...
            <div>
              ...
              <div className="space-y-3 mb-6">
                ...
                <button onClick={() => setIsSuggestionOpen(true)} className="footer-link text-sm text-left transition-colors hover:text-white flex items-center gap-3" style={{ color: "var(--text-secondary)" }}>
                  <svg className="w-4 h-4 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
