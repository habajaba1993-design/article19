      ...
      <div className="max-w-[1440px] mx-auto px-6 sm:px-8 lg:px-12">
        ...
        <ScrollReveal>
          <div className="py-14 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
            ...
            <div>
              <h3 className="text-xs font-semibold mb-5 uppercase tracking-[0.15em]" style={{ color: "var(--text-primary)" }}>Contact Us</h3>
...
function SocialIcon({ href, children, ariaLabel }: { href: string; children: React.ReactNode; ariaLabel: string }) {
  return (
    <a
      ...
      className="w-10 h-10 rounded-full flex items-center justify-center transition-all duration-300 hover:-translate-y-1 hover:border-[var(--accent-gold)] hover:text-[var(--accent-gold)]"
      style={{
